...
describe("TableCellLabel", () => {
  it("renders without errors with the given props", () => {
    ...
    expect(html).toContain(`table-cell-label-wrapper`);
    expect(html).toContain(`Firma`);
    expect(html).toContain(
      `<div data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"Firma, Gymnasium\" class=\"table-cell-label-show-more\">...</div>`,
    );
  });
});
