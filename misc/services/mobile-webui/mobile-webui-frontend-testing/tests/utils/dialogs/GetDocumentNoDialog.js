...
export const GetDocumentNoDialog = {
  ...
  typeDocumentNo: async (documentNo) =>
    await test.step(`${NAME} - Type Document No ${documentNo}`, async () => {
      await page.type("#documentNo-input", documentNo);
    }),

  clickOKButton: async () =>
    await test.step(`${NAME} - Click OK button`, async () => {
      await page.locator("#OK-button").click();
    }),

  clickCancelButton: async () =>
    await test.step(`${NAME} - Click Cancel button`, async () => {
