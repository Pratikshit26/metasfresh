...
it("Read the fixture", function () {
  cy.fixture(
    "materialReceipt/mat_receipt_quality_issue_invoice_indispute_checked.json",
  ).then((f) => {
...
it("Go to Invoice Disposition and check the billing candidates", function () {
  ...
  cy.getStringFieldValue("QtyToInvoice").should(
    "equal",
    qtyToInvoice1.toString(),
  );
