...
const FormBuilder = ({ onSave, initialForm }: {
  ...
  return (
    <div data-testid="form-builder">
      ...
      <div data-testid="question-types">
        ...
        <button onClick={() => addQuestion('multiple_choice')} data-testid="add-multiple-choice">
          Add Multiple Choice
        </button>
      </div>
...
describe('FormBuilder Component', () => {
  ...
  it('can add different question types', async () => {
    ...
    expect(screen.getByText(/New multiple_choice question/)).toBeInTheDocument()
  })
