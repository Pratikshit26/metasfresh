...
const routes = [
    ...
    {
        path: '/weekly/edit/:productId/:targetDay?/:targetDayCaption?',
        name: 'Weekly Product Edit',
        Component: ProductWeeklyEdit,
    },
                    ...
                    <Switch>
                        ...
                        <Route
                            ...
                            component={({ location }) => {
                                ...
                                return (
                                    <PasswordRecovery splat={location.pathname.replace('/', '')} token={query.token} />
                                );
                            }}
                        />
