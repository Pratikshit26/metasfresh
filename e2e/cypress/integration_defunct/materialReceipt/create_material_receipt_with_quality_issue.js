...
describe("Create material receipt with quality issue", function () {
  ...
  it("Read the fixture", function () {
    cy.fixture(
      "materialReceipt/create_material_receipt_with_quality_issue.json",
    ).then((f) => {
    ...
    new PurchaseOrder()
      ...
      .addLine(
        new PurchaseOrderLine()
          ...
          .setQuantity(purchaseOrderLineQuantity),
      )
      .apply();
  ...
  it("Check Material Receipt Line with quality issue", function () {
    ...
    cy.getStringFieldValue("QualityNote", true).should(
      "contain",
      qualityNoteName,
    );
    cy.getStringFieldValue("QualityDiscountPercent", true).should(
      "contain",
      qualityDiscountPercent,
    );
