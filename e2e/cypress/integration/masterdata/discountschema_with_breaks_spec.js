...
describe("New discount schema Test", function () {
  ...
  it("Create a discount schema record", function () {
    ...
    cy.writeIntoStringField(
      "Description",
      `Description for ${discountSchemaName}`,
      false,
    );
...
function addBreakRecord(productValue, breakValue, breakDiscount) {
  ...
  cy.clearField("BreakValue", true /*modal*/).writeIntoStringField(
    "BreakValue",
    breakValue,
    true /*modal*/,
  );
  cy.clearField("BreakDiscount", true /*modal*/).writeIntoStringField(
    "BreakDiscount",
    breakDiscount,
    true /*modal*/,
  );
