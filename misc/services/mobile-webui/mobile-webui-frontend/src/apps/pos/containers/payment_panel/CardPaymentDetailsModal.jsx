...
const CardPaymentDetailsModal = ({
    ...
    const [editingPayAmount, setEditingPayAmount] = useState(() =>
        toEditingAmount({ value: payAmountParam, precision }),
    );
            ...
            <div className="modal-card">
                ...
                <section className="modal-card-body">
                    ...
                    <div className="detail-line">
                        ...
                        <div className={cx('detail-value', { 'has-text-danger': !isPayAmountValid })}>
                            {payAmountStr}
                        </div>
                    </div>
                    {cardReaderName && (
