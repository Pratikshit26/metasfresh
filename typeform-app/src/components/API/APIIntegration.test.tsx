...
const FormResponseSubmitter = ({
  ...
  if (submitted) {
    return (
      <div data-testid="success-message">Thank you for your response!</div>
    );
  }
...
describe("API Integration Tests", () => {
  ...
  describe("FormResponseSubmitter Component", () => {
    ...
    it("submits form responses", async () => {
      render(
        <FormResponseSubmitter formId="form-1" questions={mockQuestions} />,
      );

      fireEvent.change(screen.getByTestId("input-q1"), {
        target: { value: "Answer 1" },
      });
      fireEvent.change(screen.getByTestId("input-q2"), {
    ...
    it("handles submission errors", async () => {
      formApi.submitResponse.mockRejectedValueOnce(
