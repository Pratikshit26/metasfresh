import {
  DataEntrySubTab,
  DataEntryTab,
} from "../../support/utils/dataEntryTab";
import {
  DataEntryLine,
  DataEntrySection,
} from "../../support/utils/dataEntrySection";
import {
  DataEntryField,
  DataEntryListValue,
} from "../../support/utils/dataEntryField";
...
describe("Create bpartner with custom dataentry based tabs", function () {
  ...
  it("Create dataentry fields", function () {
    ...
    section1FieldBuilder
      ...
      .setDataEntryLine(
        `${dataEntrySection1Name}_${dataEntryTabName}_${dataEntrySubTab1Name}_22`,
      )
    ...
    section1FieldBuilder
      ...
      .setDataEntryLine(
        `${dataEntrySection1Name}_${dataEntryTabName}_${dataEntrySubTab1Name}_33`,
      )
  ...
  it("Create a 2nd dataentry section and fields", function () {
    new DataEntrySection(dataEntrySection2Name, dataEntrySubTab1Name)
      .setDescription(
        "Section with one line; its two columns shall appear to be aligned with the first section",
      )
      .setSeqNo("25")
