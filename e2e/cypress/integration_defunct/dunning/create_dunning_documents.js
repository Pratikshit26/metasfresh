...
describe("Create Dunning Documents", function () {
  ...
  function checkDunningDocument(dunningLevel) {
    ...
    describe("Do the checks", function () {
      ...
      cy.getStringFieldValue("C_DunningLevel_ID").should(
        "equals",
        dunningLevel,
      );
      ...
      cy.openAdvancedEdit();
      cy.getStringFieldValue("C_DunningLevel_ID", true).should(
        "equals",
        dunningLevel,
      );
      cy.getStringFieldValue("C_Currency_ID", true).should(
        "equals",
        siCurrency,
      );
    ...
    describe(`Check reference from Dunning document to its Sales Invoices`, function () {
      ...
      DunningDocuments.getRows().contains("td", siDocumentNumber, {
        log: true,
      });
    });
  }
