export function createAndCompleteTransition(
  transitionName,
  extensionType,
  nextConditionsName,
) {
...
export function createAndCompleteRefundPercentConditions(
  conditionsName,
  transitionName,
  refundMode,
) {
...
export function createAndCompleteRefundAmountConditions(
  conditionsName,
  transitionName,
  refundMode,
) {
...
function createAmountConfig(refundMode, minQty, amount) {
  ...
  cy.getStringFieldValue("RefundAmt", true /*modal*/).then(
    (refundAmtFieldValue) => {
