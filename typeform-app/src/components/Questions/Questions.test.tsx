...
describe("Question Components", () => {
  ...
  describe("TextQuestion", () => {
    it("renders text input with label", () => {
      ...
      render(
        <TextQuestion question={question} value="" onChange={mockOnChange} />,
      );
    ...
    it("displays validation errors", () => {
      ...
      expect(screen.getByTestId("error-text-1")).toHaveTextContent(
  ...
  describe("EmailQuestion", () => {
    it("renders email input with proper type", () => {
      ...
      render(
        <EmailQuestion question={question} value="" onChange={mockOnChange} />,
      );
    ...
    it("validates email format", () => {
      ...
      expect(screen.getByTestId("error-email-1")).toHaveTextContent(
  ...
  describe("QuestionRenderer", () => {
    ...
    it("handles unsupported question types", () => {
      ...
      expect(
        screen.getByText("Unsupported question type: unsupported"),
      ).toBeInTheDocument();
    });
  });
});
