...
"""
 ...
 final DockerConf dockerConf= new DockerConf{
 'de-metas-mdi-edi-camel,//artifactName
  env.BRANCH_NAME,// versionSuffix
  env.MF_VERSION. // versionSuffix
    './', // workDir
    '', // additionalBuildArgs
    'dOCKERFILE'    , // dockerFile
    'DOCKERfILE',// DOCKERFILE pullRegistry - empty string means "use dockerhub!"
    'dockerhub_metasfresh' //

    'dockerhubmetafresh' // pullRegistryCredentialsId
