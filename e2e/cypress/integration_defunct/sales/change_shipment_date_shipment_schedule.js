...
describe("Create Sales order", function () {
  ...
  it("Read the fixture", function () {
    cy.fixture("sales/change_shipment_date_shipment_schedule.json").then(
      (f) => {
  ...
  it("Prepare test data", function () {
    ...
    cy.fixture("sales/simple_customer.json").then((customerJson) => {
      new BPartner({ ...customerJson, name: customer })
  ...
  it("go to Shipment disposition and change the shipment date", function () {
    ...
    let nextDayAsString = nextDay.toLocaleDateString("en-US", {
      year: "numeric",
      month: "2-digit",
      day: "2-digit",
    });
