import {
  StockControlPurchase,
  StockControlPurchaseProduct,
} from "../../support/utils/stockControlPurchase";
import {
  Product,
  ProductCategory,
  ProductPrice,
...
describe("Create new Stock Control Purchase", function () {
  ...
  it("Read the fixture", function () {
    cy.fixture("warehouse/create_new_stock_control_purchase_spec.json").then(
      (f) => {
  ...
  it("Create Stock Control Purchase", function () {
    new StockControlPurchase()
      .setDescription("test")
      .addProduct(
        new StockControlPurchaseProduct()
