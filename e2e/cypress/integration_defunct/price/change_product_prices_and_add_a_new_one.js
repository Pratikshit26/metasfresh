...
it("Read fixture and prepare the names", function () {
  cy.fixture("price/change_product_prices_and_add_a_new_one.json").then((f) => {
    ...
    packingInstructionsName1 = appendHumanReadableNow(
      f["packingInstructionsName1"],
    );
    packingInstructionsName2 = appendHumanReadableNow(
      f["packingInstructionsName2"],
    );
...
function expectNumberOfProductPrices(
...
function createAttribute(attributeName, attributeValue1, attributeValue2) {
  new Attribute(attributeName)
    ...
    .addAttributeValue(
      new AttributeValue(attributeValue1).setValue(attributeValue1),
    )
    .addAttributeValue(
      new AttributeValue(attributeValue2).setValue(attributeValue2),
    )
    .apply();
}
