...
test('renders RfQDailyEditEdit component correctly', () => {
    const wrapper = render(
        <MemoryRouter initialEntries={['/rfq/15/dailyQty/2021-01-01']}>
            <Provider store={store}>
                <RootStoreContext.Provider value={store}>
                    <Route exact path="/rfq/:rfqId/dailyQty/:targetDate" component={RfQDailyEdit} />
    ...
    expect(html).toContain('<div class="column is-11"><input type="number" class="product-input" step="1" value="2">');
